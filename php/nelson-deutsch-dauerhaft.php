...
<head>
    ...
    <!--TAB-TITEL-->
    <title>Auslosung Deutsch dauerhaft NMS</title>
    <!--FAVICON-->
    ...
    <div class="container">
        ...
        <div class="col-lg-12">
                    ...
                    <thead class="thead-dark">
                        ...
                        <?php
                        $con = mysqli_connect("localhost", "root", "", "Bewerberkinder 2020 NMS");
                        if ($con -> connect_error){
            ...
            <div class="col-lg-12 abschluss-col">
                ...
                <div class="danke-box">
                    ...
                    <div id="next">
                        ...
                        <a href="nelson-englisch-dauerhaft.php" class="previous round">Englisch dauerhaft &#8594; </a>
                    </div>
                </div>
            </div>
        </div>
