...
<head>
    ...
    <!--Tab-Titel-->
    <title>Auslosung Nelson-Mandela-Schule</title>
    <!--Favicon-->
    ...
    <div class="container" id="headline-container">
        <div class="row" id="headline-row">
            ...
            <div class="col-lg-9" id="text-col">    
                ...
                <h1>Nelson-Mandela-Schule<br>Auslosung</h1>
            </div>
            <!--ÜBERSCHRIFT ENDE-->
        </div>
        <hr/>
