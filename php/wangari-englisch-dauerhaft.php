...
<head>
    ...
    <!--TAB-TITEL-->
    <title>Auslosung Englisch dauerhaft WMS</title>
    <!--FAVICON-->
    ...
    <div class="container">
        <div class="row" id="headline-row">
            <div class="col-lg-8 text-col">
                ...
                <h1 id="headline-two">Kategorie: Englisch dauerhaft</h1>
        ...
        <div class="row" id="tabelle-row">
            ...
            <table class="table table-bordered table-md table-hover" id="bewerber-tabelle">
                    <thead class="thead-dark">
                        ...
                        $sql = "SELECT Losnummer, ID, Vorname, Name from EnglischDauerhaft";
        ...
        <div class="row">
            <div class="col-lg-12 abschluss-col">
                ...
                <form>
                    ...
                    <button type="button" id="abschluss-button" onclick="ausgabeTeilnehmer()" class="btn btn-dark btn-sm" 
                ...
                <div class="danke-box">
                    ...
                    <div id="next">
                        <hr>
                        <a href="index.html" class="previous round">Auslosung beenden &#8594; </a>
                    </div>
                </div>
            </div>
        </div>
