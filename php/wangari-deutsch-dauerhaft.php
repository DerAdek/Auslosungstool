...
<head>
    ...
    <!--TAB-TITEL-->
    <title>Auslosung Deutsch dauerhaft WMS</title>
    <!--FAVICON-->
    ...
    <div class="container">
        <div class="row" id="headline-row">
            <div class="col-lg-8 text-col">
                <a href="wangari.php" class="previous round">&#8249; Kontingentauswahl</a>
                <h4>Wangari-Maathai-Schule</h4>
                <h1 id="headline-two">Kategorie: Deutsch dauerhaft</h1>
        ...
        <div class="row" id="tabelle-row">
            ...
            <table class="table table-bordered table-md table-hover" id="bewerber-tabelle">
                    <thead class="thead-dark">
                        ...
                        $sql = "SELECT Losnummer, ID, Vorname, Name from DeutschDauerhaft";
        ...
        <div class="row">
            <div class="col-lg-12 abschluss-col">
                ...
                <form>
                    ...
                    <button type="button" id="abschluss-button" onclick="ausgabeTeilnehmer()" class="btn btn-dark btn-sm" disabled 
                ...
                <div class="danke-box">
                    ...
                    <div id="next">
                        ...
                        <a href="wangari-englisch-dauerhaft.php" class="previous round">Englisch dauerhaft &#8594; </a>
                    </div>
                </div>
            </div>
        </div>
