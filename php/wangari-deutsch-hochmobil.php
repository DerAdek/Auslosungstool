...
<head>
    ...
    <!--TAB-TITEL-->
    <title>Auslosung Deutsch hochmobil WMS</title>
    <!--FAVICON-->
    ...
    <div class="container">
        <div class="row" id="headline-row">
            <div class="col-lg-8 text-col">
                ...
                <h1 id="headline-two">Kategorie: Deutsch hochmobil</h1>
        ...
        <div class="row" id="tabelle-row">
            ...
            <table class="table table-bordered table-md table-hover" id="bewerber-tabelle">
                    <thead class="thead-dark">
                        ...
                        $sql = "SELECT Losnummer, ID, Vorname, Name from DeutschHochmobil";
            ...
            <div class="col-lg-12 abschluss-col">
                ...
                <div class="danke-box">
                    ...
                    <div id="next">
                        ...
                        <a href="wangari-englisch-hochmobil.php" class="previous round">Englisch hochmobil &#8594; </a>
                    </div>
                </div>
            </div>
        </div>
